...
import { exportToJson, displaySummary } from './utils/dataExporter.js';
import {
...
async function detailedScrape() {
    ...
    console.log('Navigate to your saved items...');
    ...
    const savedPath = exportToJson(detailedItems, 'detailed-items-v2');
